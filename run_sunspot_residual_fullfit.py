"""
run_sunspot_residual_fullfit.py
Level 3 Step 3: PatchTST 残差训练脚本。
基于 EXP-14 基线参数 (d_model=128)，预测目标从 ssn 改为 residual。
全量数据，不设留出验证。
"""
...
parser = argparse.ArgumentParser(description='PatchTST Residual Prediction')

# ---- basic config ----
parser.add_argument('--random_seed', type=int, default=2021)
parser.add_argument('--is_training', type=int, default=1)
parser.add_argument('--model_id', type=str, default='sunspot_residual')
parser.add_argument('--model', type=str, default='PatchTST')
parser.add_argument('--checkpoints', type=str, default='./PatchTST_supervised/checkpoints_residual/')

# ---- data loader ----
parser.add_argument('--data', type=str, default='custom')
parser.add_argument('--root_path', type=str, default='./PatchTST_supervised/dataset/')
parser.add_argument('--data_path', type=str, default='sunspot_with_residual_fullfit_v2.csv')
parser.add_argument('--features', type=str, default='M')
parser.add_argument('--target', type=str, default='residual')
...
parser.add_argument('--des', type=str, default='residual_fullfit')
