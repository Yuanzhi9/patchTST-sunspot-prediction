...
if __name__ == '__main__':
    ...
    parser.add_argument('--revin', type=int, default=1, help='RevIN; True 1 False 0')  #可逆归一化 时序模型标配（前向归一化，后向反归一化，还没懂）
    ...
    parser.add_argument('--enc_in', type=int, default=7, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels    #变量数为7，可以改
    parser.add_argument('--dec_in', type=int, default=7, help='decoder input size')#解码器部分，不懂，要看看
    parser.add_argument('--c_out', type=int, default=7, help='output size')#模型输出预测目标数
    ...
    parser.add_argument('--train_epochs', type=int, default=10, help='train epochs')##要跑的轮数原来是100
