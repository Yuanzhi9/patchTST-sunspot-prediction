...
| **EXP-18-1a** | 08.12 | Stage 8 | **Round 1 patch_len 16→12 (stride 8→6)** | sl336,pl12,str6,MS,50ep,W1 | 26.85 | 16.62 | 0.693 | ❌ 恶化12.5% ⚠️ 最终模型口径+并行训练 | L828 | ✓ |
| **EXP-18-1c** | 08.12 | Stage 8 | **Round 1 patch_len 16→24 (stride 8→12)** | sl336,pl24,str12,MS,50ep,W1 | 25.84 | 10.26 | 0.720 | ❌ 恶化8.3% ⚠️ 最终模型口径+并行训练 | L828 | ✓ |
