...
parser = argparse.ArgumentParser(description='PatchTST seq_len=192 for Ceiling Probe')

parser.add_argument('--random_seed', type=int, default=2021)
parser.add_argument('--is_training', type=int, default=1)
parser.add_argument('--model_id', type=str, default='ceiling_seq192')
...
parser.add_argument('--des', type=str, default='ceiling_seq192')
