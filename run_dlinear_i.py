...
parser = argparse.ArgumentParser(description='DLinear-I (individual=1) for Ceiling Probe')

parser.add_argument('--random_seed', type=int, default=2021)
parser.add_argument('--is_training', type=int, default=1)
parser.add_argument('--model_id', type=str, default='ceiling_dlinear_i')
...
parser.add_argument('--des', type=str, default='ceiling_dlinear_i')
